...
const char *module_file =  "matSumKernel.cubin";
const char *kernel_name =  "matSum";
...
void initCUDA()
{
    ...
    // get first CUDA device, check the environment!
...
//////////////////////////////////////////////////////////////////////////////////////
    ...
    if (err != CUDA_SUCCESS) {
        ...
        fprintf(stderr, "Create CUDA context successfully! \n");
    }
